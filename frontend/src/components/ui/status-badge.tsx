...
> = {
  ...
  recruiter_chat: { label: 'Recruiter Chat', className: 'bg-purple-100 text-purple-700 border-purple-200' },
  ...
  offer_accepted: { label: 'Offer Accepted', className: 'bg-emerald-100 text-emerald-700 border-emerald-200' },
  offer_rejected: { label: 'Offer Rejected', className: 'bg-orange-100 text-orange-700 border-orange-200' },
